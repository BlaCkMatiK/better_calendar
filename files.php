...
function afficherRoomEmpruntee($pdo)
{
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '        <input type="hidden" name="room_id" value="' . htmlspecialchars($row['room_number']) . '">'; // Utiliser le numéro de salle
    ...
    <div class="content">
        <div class="content_left">
            <div class="content_left_rooms_list">
                <h3 class="content_left_rooms_list_title">Liste des salles disponible</h3>
